    ...
    render() {
        this.innerHTML = `
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4">
                    <div class="container">
                        <a class="navbar-brand" href="../pages/sobre.html"><img src="../src/icon.png" style="width: 40px;" alt="ficha de poker"> <span class="mystery-quest fw-bold">Quirino</span></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <span class="navbar-text">
                                Escola Castelo | <a class="text-danger text-decoration-none" href="#" id="sair">Sair</a>
                            </span>
                        </div>
                    </div>
                </nav>
